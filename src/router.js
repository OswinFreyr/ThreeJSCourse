...
import Canvas4 from '@/pages/canvas/TheCanvas4.vue';
import EvaluationCanvas from '@/pages/canvas/TheEvaluationCanvas.vue';
    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: 'EvaluationCanvas',
                    name: 'EvaluationCanvas',
                    component: EvaluationCanvas
                },
            ]
        },
        {
